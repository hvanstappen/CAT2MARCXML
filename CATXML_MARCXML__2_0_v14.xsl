...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="RECORD">
        <marc:record>
            ...
            <xsl:for-each select="SSECTION/SU">
                <xsl:choose>
                    <!-- 600  subject added entry personal name - not in dataset-->
                    <!-- 610  subject added entry corporate name - not in dataset-->
                    ...
                    <!-- 653  note: 650  subject added entry topical term: is only for standard thesauris -->
