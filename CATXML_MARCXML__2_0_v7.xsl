...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="RECORD">
        <marc:record>
            ...
            <!-- controlfield tag="003" identifier van organisatie bij 001-tag> -->
            <xsl:comment>Control Number Identifier</xsl:comment>
            <marc:controlfield tag="003">provant.be</marc:controlfield>
            <!-- controlfield 005: laatste transactie; er is geen tag voor datum creatie record?
            ...
            <!-- MaandQuotient1 wordt berekend op deel na decimaal van jaarquotient/12*10 -->
            <xsl:variable name="MaandQuotient">
                <xsl:value-of
                    select="(floor((number($JaarQuotient) - floor(number($JaarQuotient))) * 12 + 1))"
                />
            </xsl:variable>
            <!-- MaandQuotient2 wordt berekend door afgeronde MaandQuotient1 aan te vullen met voorlooptnullen) -->
            ...
            <marc:controlfield tag="008">
                <xsl:value-of select="concat(substring($JaarQuotient,3,2),$MaandQuotient2,'01')"/>
            ...
            <xsl:for-each select="BSECTION/NT[@ty='br']">
                ...
                <marc:datafield tag="024" ind1="7" ind2="0">
                    ...
                    <marc:subfield code="a">
                        <xsl:value-of select="substring-before(substring-after(DATA,'STCV '),'&lt;')"></xsl:value-of>
                    </marc:subfield>
                </marc:datafield>
            </xsl:for-each>
            ...
            <xsl:if test="BSECTION/TI/@ty='u'">
                ...
                <marc:datafield tag="240" ind1="1" ind2="0">
                    <marc:subfield code="a">
                        <xsl:value-of select="BSECTION/TI"/>
                    </marc:subfield>
                </marc:datafield>
            </xsl:if>
            ...
            <xsl:for-each select="RSECTION/RELATION">
                <xsl:choose>
                    <xsl:when test="@ty='ong'">
                        <xsl:comment>Constituent Unit Entry</xsl:comment>
                    ...
                    <xsl:when test="@ty='co'">
                        <xsl:comment>Preceding Entry</xsl:comment>
                    ...
                    <xsl:when test="@ty='cb'">
                        <xsl:comment>Succeeding Entry</xsl:comment>
                    ...
                    <!-- al de rest in 787 (gevonden relatietypes :  tda, vnr, ong, atd, rnv -->
                    <xsl:otherwise>
                        <xsl:comment>Other Relationship Entry</xsl:comment>
                        <marc:datafield tag="787" ind1="1" ind2=" ">
                            <marc:subfield code="a">
            ...
            <marc:datafield tag="884" ind1=" " ind2=" ">
                ...
                <marc:subfield code="q">immd.be </marc:subfield>
                <marc:subfield code="h">http://www.immd.be/schemas/CATXML_MARCXML.xsl
                </marc:subfield>
            </marc:datafield>
            ...
            <marc:datafield tag="887" ind1=" " ind2=" ">
                <marc:subfield code="a">
                    <xsl:value-of
                        select="concat(floor(number($JaarQuotientcd)),$MaandQuotient2cd,'01000000.0')"
                    />
                </marc:subfield>
                <marc:subfield code="2"> http://webi.provant.be/brocade/catalog/catxml.dtd
                    TSECTION/@cd</marc:subfield>
            </marc:datafield>
            <xsl:for-each select="BSECTION/IM[1]">
                ...
                <marc:datafield tag="887" ind1=" " ind2=" ">
                    ...
                    <marc:subfield code="2"> http://webi.provant.be/brocade/catalog/catxml.dtd
                        BSECTION/IM/JU/@ju1sv </marc:subfield>
                </marc:datafield>
            </xsl:for-each>
            ...
            <xsl:for-each select="BSECTION/IM[1]">
                <marc:datafield tag="887" ind1=" " ind2=" ">
                    ...
                    <marc:subfield code="2"> http://webi.provant.be/brocade/catalog/catxml.dtd
                        BSECTION/IM/JU/@ju2sv </marc:subfield>
                </marc:datafield>
            </xsl:for-each>
        </marc:record>
    </xsl:template>
